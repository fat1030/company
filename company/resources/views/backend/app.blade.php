    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-calculator"></i> <span>Company</span>
                        <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="/admin/CompanyName"><i class="fa fa-circle-o"></i> Company Name</a></li>
                        <li><a href="/admin/Person"><i class="fa fa-circle-o"></i> Person</a></li>
                    </ul>
                </li>
